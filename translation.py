...
START_MESSAGE = '''**Hello, {}
I Am mdiskshortner.link, Bulk Link Converter. I Can Convert Links Directly From Your mdiskshortner Account,
    
1. Go To 👉 https://mdiskshortner.link//member/tools/api  
2. Than Copy API Key
...
START_MESSAGE_REPLY_MARKUP  = InlineKeyboardMarkup([
    [
        InlineKeyboardButton('Get Api', url=f'https://mdiskshortner.link/member/tools/api')
    ]
])
...
USER_ABOUT_MESSAGE = """
- Website: [{base_site}](https://www.google.com/url?sa=t&source=web&rct=j&url=https://mdiskshortner.link/&ved=2ahUKEwjZuNSK16T9AhW68DgGHThpDrUQFnoECA4QAQ&usg=AOvVaw1P6Skp5Xduqm64uAG0yXvB)
...
Get API From [{base_site}](https://mdiskshortner.link/ref/rngharman)
...
USERNAME_TEXT = """**Hello Harman, I am , Bulk Link Converter Bot From Linked mdiskshortner.linkAccount,**
